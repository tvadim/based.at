...
jQuery(document).ready(function($){
	...
	(function() {
		...
		inputFile.each(function(){
			...
			var self = $(this),
				fakefile = "<div class='fakefile'>",
				inputtext = "<input type='text'>",
				link = "<a href='#' class='browse'>browse...</a>";
				self.addClass('file hidden')
			self.wrap("<div class='fileinputs'>")
				.parent()
				.append(fakefile).find('.fakefile')
				.append(inputtext, link);
		})
		
		inputFile.on("change",function(){
			var self = $(this);
			var val = self.val();
			self.next(".fakefile").find('input').val(val);
		});
